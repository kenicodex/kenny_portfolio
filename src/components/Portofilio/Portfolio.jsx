...
function Portfolio() {
  ...
  return (
    <Box sx={{ backgroundColor: "auto", textAlign: "center" }} >
      ...
      {/* </Grow> */}
      <Box sx={{ height: "100vh", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }} className='bg-white'>
        ...
        <Box sx={{display:"flex", flexWrap:"wrap", justifyContent:"space-evenly"}} >
          <Link to="/todolist"><Button variant="outlined" color="success" sx={{ width: "150px" }}>Todolist</Button></Link>
          <Link to="/movies"><Button variant="outlined" color="success" sx={{ width: "150px" }}>Movies</Button></Link>
          <Link to="/fakestore"><Button variant="outlined" color="success" sx={{ width: "150px" }}>Ecommerce</Button></Link>
        </Box>
      </Box>
      <Divider />
      <Box sx={{ display: "flex", height: "100vh", flexDirection: { xs: "column", lg: "row" }, color: "white", justifyContent: "center", px: { xs: "auto", lg: "50px" }, mt: "40px" }}>
        {know.map(({ name }) => {
          return (<Zoom in={bool[1]} timeout={3000}>
            <Box sx={{
              display: "flex", flexDirection: "column", justifyContent: 'space-around', my: "20px", bgcolor: 'black',
